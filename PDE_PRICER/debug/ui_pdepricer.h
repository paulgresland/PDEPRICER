...
**
** Created: Fri 13. Feb 04:50:51 2015
...
public:
    ...
    void setupUi(QMainWindow *PDEPricer)
    {
        ...
        StructureWindow->setMinimumSize(QSize(250, 150));
        StructureWindow->setMaximumSize(QSize(300, 16777215));
        ...
        AddStructureWindow->setMaximumSize(QSize(300, 80));
        ...
        RunsWindow->setMinimumSize(QSize(250, 300));
        RunsWindow->setMaximumSize(QSize(300, 16777215));
        ...
        Runs->setMaximumSize(QSize(300, 16777215));
        ...
        AddRunSettingWindow->setMaximumSize(QSize(300, 80));
        ...
        menubar->setGeometry(QRect(0, 0, 1080, 38));

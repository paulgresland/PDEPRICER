...
public:
    ...
    void setupUi(QWidget *RunSettings)
    {
        ...
        T = new QDoubleSpinBox(widget_10);
        ...
        P = new QDoubleSpinBox(widget_13);
    ...
    void retranslateUi(QWidget *RunSettings)
    {
        ...
        FenetreType_3->setText(QApplication::translate("RunSettings", "<html><head/><body><p><span style=\" font-size:10pt;\">PAS DE DISCRETISATION</span></p></body></html>", 0, QApplication::UnicodeUTF8));
